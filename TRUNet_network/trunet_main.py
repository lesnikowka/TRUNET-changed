...
from model.ViT import VisionTransformer3d as TransUNet3d
...
save_path = './logs/run_' + now.strftime("%m%d%Y_%H%M%S")
...
parser.add_argument('--num_classes', type=int,
                    default=8, help='number of class')
parser.add_argument('--batch_size', type=int,
                    default=1, help='training batch size')
parser.add_argument('--root_path', type=str,
                    default='C:/Users/nik/Desktop/обработка датасета для TRUNET/out', help='path with train and val directories')
parser.add_argument('--save_path', type=str,
                    default=save_path, help='path to save outputs')
...
class fetch_dataset:
    def __init__(self, base_dir, crop=None, transform=None):
        ...
        self.name = [os.path.basename(i).split('.npz')[0] for i in sample_list]
